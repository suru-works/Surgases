...
const OrderProductModal = (props) => {
    ...
    const { handleSubmit, handleChange, handleBlur, resetForm, touched, values, errors } = useFormik({
        ...
        onSubmit(values) {
            ...
            let aux = props.UpdateOldOrderProduct({product, oldProduct});
            setError(aux);
            if(!aux){
                toggleAndReset();
            }
    ...
    const deleteProduct = () => {
        ...
        props.deleteOldOrderProduct(productData);
    }
    if (error) {
        return (
...
const EditOldOrderComponent = (props) => {

    if(props.product){
        return(
            <OrderProductModal updateOldOrderProduct={props.updateOldOrderProduct} deleteOldOrderProduct={props.deleteOldOrderProduct} 
...
EditOldOrderComponent.propTypes = {};

export default EditOldOrderComponent;